...
<head>
    ...
    <title>Medicare Part D Prescribers</title>
...
<body>
    <div class="chat-container">
        <div class="chat-header"><span>Medicare Part D Prescribers</span><button class="new-chat-btn" onclick="window.location.reload()" title="New Chat"><i data-lucide="plus-circle"></i></button></div>
        <div class="chat-messages" id="chat-messages">
            <div class="welcome-screen" id="welcome-screen">
                <div class="welcome-icon"><i data-lucide="bot"></i></div><h2>Medicare Part D Prescribers</h2>
                <div class="sample-questions">
                    <div class="sample-question" onclick="askSample(this)"><span>Top 5 meds by n of patients, prescribed by Peter Boling?</span></div>
                    <div class="sample-question" onclick="askSample(this)"><span>Top prescribers of Trulicity?</span></div>
                </div>
            </div>
        </div>
